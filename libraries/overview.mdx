...
- [dart:collection](/libraries/dart-collection) - Collections and data structures
- [dart:convert](/libraries/dart-convert) - Encoders and decoders (JSON, UTF-8, Base64)
...
- [dart:js_interop](/libraries/dart-js-interop) - JavaScript interoperability
- [dart:math](/libraries/dart-math) - Mathematical functions and constants
